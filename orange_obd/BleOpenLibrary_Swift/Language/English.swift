...
class English{
    static let dic=["app_name":"USB Tx",
        ...
        "Next":"Next",
        "error":"error",
        "Programming_failed_where":"Program fail,( Failed tire position )",
